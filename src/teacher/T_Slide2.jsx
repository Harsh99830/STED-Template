...
import TeacherFeedbackList from "./TeacherFeedbackList"; // Import new component
...
export default function T_Slide2() {
  ...
  const sections = [
    ...
    <div className="section-content" style={{marginBottom:"100px"}}>
      <TeacherFeedbackList/>
  </div>,
  ...
  return (
    <>
      ...
      <FullPageScroll sections={sections} colors={colors} prevSlide="/teacher-slide-1" guideSections={guideSections} />
